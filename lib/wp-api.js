...
WpApi.prototype.fetchOauthRequestToken = function ( oauthConfig, callback ) {
	...
	this._discoverDescribe( function ( error, wpApiDescription ) {
		...
		oauth.fetchRequestToken( oauthConfig, url, form, function ( error, response ) {
			...
			queryString = '?oauth_token=' + encodeURIComponent( response.oauth_token );
			response.authorizeUrl = oauthEndpoints.authorize + queryString;
...
WpApi.prototype.fetchOauthAccessToken = function ( oauthConfig, callback ) {
	...
	this._discoverDescribe( function ( error, wpApiDescription ) {
		...
		oauth.fetchAccessToken( oauthConfig, url, form, callback );
	});
};
...
WpApi.prototype._auth = function ( requestConfig ) {
	...
	if ( this.oauthConfig ) {
		...
		requestConfig.headers.Authorization = oauth.makeAuthorizationHeader( this.oauthConfig, oauthOptions );
