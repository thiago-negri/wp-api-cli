...
WpApi.prototype.deleteMeta = function ( postID, metaID, callback ) {
	this._delete( [ 'posts', postID, 'meta' ], metaID, callback );
};
...
WpApi.prototype.listRevision = function ( postID, callback ) {
	this._list( [ 'posts', postID, 'revisions' ], callback );
};

WpApi.prototype.getRevision = function ( postID, revisionID, callback ) {
	this._get( [ 'posts', postID, 'revisions' ], revisionID, callback );
};

WpApi.prototype.deleteRevision = function ( postID, revisionID, callback ) {
	this._delete( [ 'posts', postID, 'revisions' ], revisionID, callback );
};
...
WpApi.prototype.deleteMedia = function ( mediaID, callback ) {
	this._delete( [ 'media' ], mediaID, callback );
};
...
WpApi.prototype.listComments = function ( postID, callback ) {
	var queryArgs;
	...
	this._list( [ 'comments' ], queryArgs, callback );
};

WpApi.prototype.createComment = function ( theComment, callback ) {
	this._create( [ 'comments' ], theComment, callback );
};

WpApi.prototype.updateComment = function ( theComment, callback ) {
	this._update( [ 'comments' ], theComment, callback );
};

WpApi.prototype.getComment = function ( commentID, callback ) {
	this._get( [ 'comments' ], commentID, callback );
};

WpApi.prototype.deleteComment = function ( commentID, callback ) {
	this._delete( [ 'comments' ], commentID, callback );
};
...
WpApi.prototype.listTaxonomies = function ( callback ) {
	this._list( [ 'taxonomies' ], callback );
};

WpApi.prototype.getTaxonomy = function ( taxonomyID, callback ) {
	this._get( [ 'taxonomies' ], taxonomyID, callback );
};
...
WpApi.prototype._list = function ( collectionName, queryArgs, callback ) {
	var self = this;
